...
citation: "<strong>Muzellec, S.</strong>, Alghetaa, Y. K., Kornblith, S., & Kar, K. (2025). MAPS: Masked Attribution-based Probing of Strategies — A computational framework to align human and model explanations. Under revision at Communications Psychology."
featured: true
header:
    teaser: "maps.jpeg"
---
